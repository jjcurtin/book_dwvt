...
However, given how often we do this, we have wrapped these rules into a simple function.  This function is reproduced here, but also shared in our fun_ml.R script on github.  If you source that script, you can call this function directly along with setting the depends.ok policy.
