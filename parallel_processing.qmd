...
Lets use them by setting up a parallel backend.  This works on Windows and Mac OSs.  We prefer to use namespace when calling these functions rather than loading full packages
```{r}
